...
verbose=False
#eCALIFA
fe_dir = '/home/espinosa/data/CALIFA_DATA/dataproducts/fe_files/'
sfh_dir = '/home/espinosa/data/CALIFA_DATA/dataproducts/sfh_files/'
ssp_dir = '/home/espinosa/data/CALIFA_DATA/dataproducts/ssp_files/'
#pCALIFA
p_fe_dir = '/home/espinosa/data/CALIFA_DATA/pCALIFA/fe_files_corr/'
p_sfh_dir = '/home/espinosa/data/CALIFA_DATA/pCALIFA/sfh_files/'
p_ssp_dir = '/home/espinosa/data/CALIFA_DATA/pCALIFA/ssp_files/'
...
def extract_HIIregions(obj_name):
    ...
    dist=0
    min_flux=0.05
    output_path='/home/espinosa/data/CALIFA_DATA/eCALIFA/catalog/'
    ...
    a = pyHIIexplorer(fe_file, output_path, max_dist, frac_peak, F_max, dist,
                      min_flux, verbose=verbose, n_index=45)
    a.HIIrecover()
    
    seg_map = output_path + "seg_Ha.{}.fits.gz".format(obj_name)
    print(seg_map)
    extract_flux_elines_table(seg_map, fe_file, output_path, verbose)
...
def extract_HIIregions_p(obj_name):
    if obj_name in ['ngc1058', ' ngc1637', 'ngc3184', 'ngc4625', 'ngc628',
        ...
        min_flux=0.05
    p_flag = True
    output_path='/home/espinosa/data/CALIFA_DATA/pCALIFA/catalog/'
    ...
    a = pyHIIexplorer(fe_file, output_path, max_dist, frac_peak, F_max, dist,
                      min_flux, p_flag, verbose=verbose, n_index=45)
    a.HIIrecover()
